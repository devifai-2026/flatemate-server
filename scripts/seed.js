...
const pgs = [
  ...
  { title: 'Budget PG Vashi', description: 'Affordable PG with basic amenities. Non-AC triple room. Near Vashi railway station.', location: 'Mumbai', city: 'Mumbai', rent: 5500, deposit: 5500, gender: 'male', sharing: 'triple', meals: true, mealType: 'both', amenities: ['wifi', 'meals'], images: ['https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=800&q=80', 'https://images.unsplash.com/photo-1540518614846-7eded433c457?w=800&q=80', 'https://images.unsplash.com/photo-1574362848149-11496d93a7c7?w=800&q=80'], availableFrom: new Date('2026-04-01'), phoneVisibility: 'masked', contactPhone: '9876543210', ownerIdx: 0 },
  { title: 'Premium Girls PG South Delhi', description: 'AC rooms, attached bath, meals, laundry. 24/7 security. Near metro.', location: 'Delhi', city: 'Delhi', rent: 12000, deposit: 12000, gender: 'female', sharing: 'double', meals: true, mealType: 'both', amenities: ['wifi', 'ac', 'meals', 'security', 'laundry'], images: ['https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&q=80', 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&q=80', 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80'], availableFrom: new Date('2026-04-10'), phoneVisibility: 'masked', contactPhone: '9876543212', ownerIdx: 2 },
  { title: 'Boys PG in Electronic City', description: 'Tech park proximity. AC double sharing with meals. Gym and common area.', location: 'Bangalore', city: 'Bangalore', rent: 7500, deposit: 7500, gender: 'male', sharing: 'double', meals: true, mealType: 'both', amenities: ['wifi', 'ac', 'meals', 'gym'], images: ['https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=800&q=80', 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&q=80', 'https://images.unsplash.com/photo-1560185893-a55cbc8c57e8?w=800&q=80'], availableFrom: new Date('2026-04-20'), phoneVisibility: 'masked', contactPhone: '9876543211', ownerIdx: 1 },
];
